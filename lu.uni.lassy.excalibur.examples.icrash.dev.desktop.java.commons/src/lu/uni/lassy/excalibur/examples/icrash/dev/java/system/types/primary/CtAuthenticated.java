...
public abstract class CtAuthenticated implements Serializable {
	...
	public PtBoolean vpIsLoggedStep1;
	/**  The user's phone number. */
	public DtPhoneNumber phNb;
	 ...
	 */
	public PtBoolean init(DtLogin aLogin, DtPassword aPwd, DtPhoneNumber aPhNb){
			login = aLogin;
			pwd = aPwd;
			phNb = aPhNb;
			vpIsLogged = new PtBoolean(false);
			vpIsLoggedStep1 = new PtBoolean(false);
